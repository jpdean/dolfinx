...
from dolfin.function.function import Function, Constant
...
__all__ = [
    ...
    "TrialFunctions", "Function", "Constant", "FunctionSpace",
    "VectorFunctionSpace", "TensorFunctionSpace", "compile_expression",
    "jit_generate", "CellDiameter", "CellNormal", "CellVolume",
